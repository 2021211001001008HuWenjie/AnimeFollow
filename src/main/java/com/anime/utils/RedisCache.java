...
public class RedisCache {
     ...
     * @return true=设置成功；false=设置失败
     */
    public boolean expire(final String key, final long timeout, final
    TimeUnit unit)
    {
    ...
    {
        Long count = redisTemplate.opsForList().rightPushAll(key,
                dataList);
     ...
     * @param dataMap
     */
    public <T> void setCacheMap(final String key, final Map<String, T>
            dataMap)
    {
        if (dataMap != null) {
